...
# ============================================================================
# print(featurDF[['대구 달서구','6억 이하']][132:])
x_train,x_test,y_train,y_test=train_test_split(featurDF[['대전 유성구']][132:],(targetDF.T['대전 유성구'][:-2]))
...
for name,class_ in regressor:   
    ...
    # print(pred)
    # y_test=target_scale(targetDF.T['서울 양천구'][:-2])
