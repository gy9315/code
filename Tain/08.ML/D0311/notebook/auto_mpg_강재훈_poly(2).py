...
# print(DF.dtypes)
DF1=DF[["displacement",'horsepower',"weight",'cylinders','acceleration','model year','origin']]
# ======================================
# # target column: mpg[1]
# # feature column 확인
...
x_train,x_test,y_train,y_test=train_test_split(DF1,DF['mpg'],random_state=1)
