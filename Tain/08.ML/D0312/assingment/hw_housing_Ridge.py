...
x_train,x_test,y_train, y_test=train_test_split(DF.loc[:,['RM','DIS','TAX','B','LSTAT']],DF['MEDV'])
score_rmse_dict={}
# ================================================================
# 이상치 처리
...
#         #=============================================================
        model=make_pipeline(PolynomialFeatures(degree=2),Ridge(alpha=alpha,solver='auto'))
